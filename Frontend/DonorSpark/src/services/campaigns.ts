...
const sampleCampaigns: Campaign[] = [
  {
    id: 'books-for-every-child',
    title: 'Books for Every Child',
    description: 'A campaign to provide learning materials to underprivileged students in Singapore.',
    targetAmount: 1000,
    currentAmount: 500,
    endDate: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString(),
    category: 'education',
    organizationId: 'rUeUuomy1NfZqX5o9xexEhzd9vgb1qCkJD',
    organizationName: 'SG Learning Foundation',
    organizationDescription: 'A registered non-profit helping kids access education.',
    organizationWebsite: 'https://sglearning.org',
    image: 'https://images.unsplash.com/photo-1481627834876-b7833e8f5570',
    status: 'active',
    createdAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
    campaignWalletAddress: 'rBooksForEveryChildWallet123456789',
  },
  {
    id: '1',
